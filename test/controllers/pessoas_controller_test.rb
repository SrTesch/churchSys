...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference("Pessoa.count") do
      post pessoas_url, params: { pessoa: { email: @pessoa.email, enderecoL1: @pessoa.enderecoL1, idade: @pessoa.idade, nome: @pessoa.nome, numCasa: @pessoa.numCasa } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { email: @pessoa.email, enderecoL1: @pessoa.enderecoL1, idade: @pessoa.idade, nome: @pessoa.nome, numCasa: @pessoa.numCasa } }
